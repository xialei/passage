...
public class Strategy implements org.apache.thrift.TBase<Strategy, Strategy._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(Strategy other) {
    ...
    Strategy typedOther = (Strategy)other;

    lastComparison = Boolean.valueOf(isSetSType()).compareTo(typedOther.isSetSType());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSType()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.sType, typedOther.sType);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
        ...
        switch (schemeField.id) {
          case 1: // S_TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.sType = Storage.findByValue(iprot.readI32());
